...
from prompt_lib.prompts.utils import PromptConfig, TaskConfig, make_task_file_from_config
...
def read_config_and_populate_defaults(config_path: str, args) -> dict:
    ...
    critical_fields = ["task_id", "model_name", "temperature", "seed", "num_examples", "num_questions_per_thread"]
